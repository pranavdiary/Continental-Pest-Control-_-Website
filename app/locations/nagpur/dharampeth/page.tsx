...
export const metadata = {
  title: 'Pest Control Services in Dharampeth, Nagpur | Continental Pest Control',
  description: 'Local pest control experts serving Dharampeth, Nagpur. Fast, reliable termite, rodent, and cockroach treatments for homes and businesses in Dharampeth.',
};

export default function DharampethLocationPage() {
  return (
    <div className="w-full">
      {/* Location Hero */}
      <section className="bg-primary-900 text-white py-20 sm:py-32 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 bg-[url('https://picsum.photos/1920/1080?random=30')] bg-cover bg-center mix-blend-overlay" />
        <div className="relative max-w-7xl mx-auto px-4 text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-emerald-400 text-sm font-bold tracking-wide uppercase backdrop-blur-md border border-white/10">
            ...
            Serving Dharampeth, Nagpur
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight font-display max-w-4xl mx-auto">
            Expert Pest Control in Dharampeth
          </h1>
          <p className="text-xl text-zinc-300 leading-relaxed max-w-2xl mx-auto">
            Continental Pest Control provides rapid, reliable, and guaranteed pest eradication services for residential and commercial properties in Dharampeth.
          </p>
          <div className="pt-8">
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-3xl font-bold text-zinc-900 font-display">
              Your Local Exterminators in Dharampeth
            </h2>
            <p className="text-lg text-zinc-600 leading-relaxed">
              Dharampeth is one of Nagpur&apos;s premier residential and commercial hubs. With its mix of independent bungalows, apartments, and bustling cafes, it requires specialized pest management. We understand the unique pest challenges in this area, from seasonal mosquito swarms to persistent cockroach issues in commercial kitchens.
            </p>
            
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-zinc-900">Services Popular in Dharampeth:</h3>
            ...
            <div className="pt-6">
               <Link href="/contact" className="inline-flex items-center gap-2 text-emerald-600 font-bold hover:text-emerald-700 transition-colors">
                Book an inspection in Dharampeth <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
          ...
          <div className="bg-zinc-50 p-8 sm:p-12 rounded-3xl border border-zinc-200 relative">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-zinc-600 italic">&quot;Excellent service! They resolved the termite issue in our Dharampeth bungalow quickly and professionally. Highly recommended.&quot;</p>
                <p className="text-sm font-bold text-zinc-900">- Rajesh K., Dharampeth</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-zinc-600 italic">&quot;We run a cafe in Dharampeth and rely on Continental for our monthly pest control. They are always on time and use odorless chemicals.&quot;</p>
                <p className="text-sm font-bold text-zinc-900">- Sneha P., Cafe Owner</p>
              </div>
            </div>
          </div>
        </div>
